...
export default function Signup(props) {
  ...
  return (
    ...
    //     />
    //     <Spacer y={2} />
    //     <Input clearable underlined labelPlaceholder="USN" name="USN" />
    //     <Spacer y={2} />
    //     <Input clearable underlined labelPlaceholder="Sem" name="Sem" />
    //     <Spacer y={2} />
    //     <Input clearable underlined labelPlaceholder="CGPA" name="CGPA" />
    //     <Spacer y={2} />
    //     <Input
    //       clearable
    //       underlined
    ...
    //   </Dropdown>*/}
    //   </form>
    //   <Button onClickCapture={saveUser}>Enter Details</Button>
    //   <Spacer y={1} />
    // </div>
      ...
      <div className="flex flex-col items-center min-h-screen pt-6 sm:justify-center sm:pt-0 bg-neutral-100">
        <div className="w-full px-10 pt-6 pb-10 mt-6 overflow-hidden bg-white shadow-md sm:max-w-lg sm:rounded-lg">
          <form>
            ...
            <Dropdown  options={departmentNames} className=" flex w-full h-40 px-2 py-2 mt-4"  placeholder="Choose Department"> </Dropdown>
            <div className="mt-4">
              <div className="flex flex-col items-start ">
                <input
                  type="Number"
